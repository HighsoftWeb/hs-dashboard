...
export const CriarProdutoSchema = z.object({
  DES_PRODUTO: z.string().max(200, "DES_PRODUTO deve ter no máximo 200 caracteres").nullable().optional(),
  desProduto: z.string().max(200, "desProduto deve ter no máximo 200 caracteres").nullable().optional(),
  ...
  (data) => {
    ...
    return desProduto !== undefined && desProduto !== null && desProduto.trim().length > 0;
  },
  {
