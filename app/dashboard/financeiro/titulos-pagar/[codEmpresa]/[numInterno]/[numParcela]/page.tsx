      ...
      <div className="space-y-4">
        <div className="flex justify-between items-start">
          <div>
            ...
            <div className="mt-1 flex items-center gap-3 text-xs text-gray-600">
              <span>Parcela: <strong>{titulo.NUM_PARCELA}</strong></span>
            </div>
          </div>
          <button
            onClick={() => router.back()}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-2">
            ...
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">Número Interno</label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">Parcela</label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">Número Documento</label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">Vencimento Original</label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">Vencimento Prorrogado</label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">Último Pagamento</label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">Provável Pagamento</label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">Portador</label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">Título Banco</label>
              <input
                type="text"
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-2">
            ...
            <div className="flex flex-col">
              ...
              <input
                type="text"
                value={titulo.PER_DESCONTO ? `${titulo.PER_DESCONTO.toFixed(2)}%` : "-"}
                readOnly
                className="w-full px-2 py-1.5 text-sm border border-gray-300 rounded focus:ring-1 focus:ring-[#094A73] focus:border-transparent bg-white"
              />
            </div>
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">% Juros/Mês</label>
              <input
                type="text"
                value={titulo.PER_JUROS_MES ? `${titulo.PER_JUROS_MES.toFixed(2)}%` : "-"}
                readOnly
                className="w-full px-2 py-1.5 text-sm border border-gray-300 rounded focus:ring-1 focus:ring-[#094A73] focus:border-transparent bg-white"
              />
            </div>
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">Juros/Dia</label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">% Multa</label>
              <input
                type="text"
