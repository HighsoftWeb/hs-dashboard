    ...
    async function carregarDados() {
      try {
        ...
        if (!resposta.success || !resposta.data) {
          throw new Error(resposta.error?.message || "Erro ao carregar empresa");
        }
    ...
    return (
      <LayoutDashboard>
        <div className="bg-red-50 border-l-4 border-red-500 rounded-lg p-4">
          <p className="text-sm text-red-800">{erro || "Empresa não encontrada"}</p>
          <button
            onClick={() => router.back()}
    ...
    <LayoutDashboard>
      <div className="space-y-4">
        <div className="flex justify-between items-start">
          <div>
            ...
            <div className="mt-1 flex items-center gap-3 text-xs text-gray-600">
              <span>Código: <strong>{empresa.COD_EMPRESA}</strong></span>
            </div>
          </div>
          <button
            onClick={() => router.back()}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3">
          <h2 className="text-base font-semibold text-gray-900 mb-3">Dados da Empresa</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-2">
            ...
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">CNPJ</label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">Inscrição Estadual</label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">Inscrição Municipal</label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              ...
              <input
                type="text"
                value={empresa.NOM_CIDADE && empresa.SIG_ESTADO
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3">
          <h2 className="text-base font-semibold text-gray-900 mb-3">Endereço de Entrega</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-2">
            <div className="flex flex-col">
              <label className="block text-xs font-medium text-gray-700 mb-0.5">Endereço</label>
              <input
            ...
            <div className="flex flex-col">
              ...
              <input
                type="text"
                value={empresa.NOM_CIDADE_ENTREGA && empresa.SIG_ESTADO_ENTREGA
