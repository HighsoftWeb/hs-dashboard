...
export async function GET(
  request: NextRequest,
  { params }: { params: Promise<{ codEmpresa: string; numInterno: string; numParcela: string }> }
  ...
  try {
    ...
    return tratarErroAPI(erro, {
      endpoint: "/api/dashboard/financeiro/titulos-pagar/[codEmpresa]/[numInterno]/[numParcela]",
      method: "GET",
    });
  }
}
